    ...
    <div class="row g-3">
      <div class="col-md-4">
        ...
        <ul class="list-unstyled mb-0">
          <li><a href="<?= htmlspecialchars(url(''), ENT_QUOTES, 'UTF-8') ?>">Accueil</a></li>
          <li><a href="<?= htmlspecialchars(url('menus'), ENT_QUOTES, 'UTF-8') ?>">Nos menus</a></li>
          <li><a href="<?= htmlspecialchars(url('contact'), ENT_QUOTES, 'UTF-8') ?>">Contact</a></li>
        </ul>
      </div>
      <div class="col-md-4">
...
Email : <?= htmlspecialchars($siteSettings['caterer_email'] ?? "contact@vite-gourmand.com") ?></p>
    ...
    <div class="border-top pt-3 mt-3 d-flex gap-3 small">
      <a href="<?= htmlspecialchars(url('mentions-legales'), ENT_QUOTES, 'UTF-8') ?>">Mentions légales</a>
      <a href="<?= htmlspecialchars(url('cgv'), ENT_QUOTES, 'UTF-8') ?>">CGV</a>
    </div>
  </div>
</footer>
