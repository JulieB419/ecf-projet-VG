...
<form method="post" class="row g-3">
  ...
  <div class="col-12 d-flex gap-2">
    ...
    <a class="btn btn-outline-secondary" href="<?= htmlspecialchars(url('inscription'), ENT_QUOTES, 'UTF-8') ?>">Créer un compte</a>
  </div>
  <div class="col-12"><a href="<?= htmlspecialchars(url('mot-de-passe-oublie'), ENT_QUOTES, 'UTF-8') ?>">Mot de passe oublié ?</a></div>
</form>
