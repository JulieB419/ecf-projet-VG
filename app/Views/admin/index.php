...
<div class="row g-3">
  ...
  <div class="col-md-6">
    <div class="card h-100 shadow-sm border-success-subtle">
      <div class="card-body">
        <h2 class="h5 mb-2">Voir les statistiques</h2>
        <p class="text-muted mb-3">Consulter le chiffre d'affaires, le nombre de commandes et les performances par menu.</p>
        <a class="btn btn-success" href="<?= htmlspecialchars(url('administration/stats'), ENT_QUOTES, 'UTF-8') ?>">Ouvrir</a>
      </div>
    </div>
  </div>
