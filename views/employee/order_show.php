...
<form method="post" action="<?= $baseUrl ?>/espace-employe/commandes/<?= (int)$order['id'] ?>/statut" class="row g-2 mb-4">
...
<form method="post" action="<?= $baseUrl ?>/espace-employe/commandes/<?= (int)$order['id'] ?>/annuler" class="row g-2 mb-4">
  <input type="hidden" name="csrf" value="<?= htmlspecialchars(Session::csrf()) ?>">
  <div class="col-md-3">
