...
<form method="post" action="/administration/informations" class="card p-3">
...
<form method="post" action="/administration/informations/horaires" class="card p-3">
  ...
  <div class="table-responsive">
    <table class="table align-middle">
      ...
      <tbody>
        ...
        ?>
        <tr data-opening-hours-row>
          <td class="fw-semibold"><?= htmlspecialchars($days[$d]) ?></td>
          <td class="time-cell"><input type="time" class="form-control" name="open_time[<?= $d ?>]" value="<?= htmlspecialchars($open) ?>" <?= $isClosed ? 'disabled' : '' ?>></td>
          <td class="time-cell"><input type="time" class="form-control" name="close_time[<?= $d ?>]" value="<?= htmlspecialchars($close) ?>" <?= $isClosed ? 'disabled' : '' ?>></td>
