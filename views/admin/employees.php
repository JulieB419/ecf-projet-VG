...
<form class="row g-2 mb-3" method="get">
  ...
  <div class="col-md-6 d-flex gap-2">
    ...
    <a class="btn btn-outline-secondary" href="<?= $baseUrl ?>/administration/employes/nouveau">Créer</a>
  </div>
</form>
        ...
        <tr>
          ...
          <td class="text-end">
            <?php if ((int)$e['is_active']===1): ?>
              <form method="post" action="<?= $baseUrl ?>/administration/employes/<?= (int)$e['id'] ?>/desactiver">
